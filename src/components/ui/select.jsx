...
const SelectContent = React.forwardRef(({ className, children, position = "popper", container, ...props }, ref) => {
  const content = (
    <SelectPrimitive.Content
      ...
      onPointerDownOutside={(e) => {
        // Prevent closing when clicking inside custom modals
        const target = e.target;
        if (target?.closest?.('[data-radix-select-content]') || target?.closest?.('.clay-card')) {
          e.preventDefault();
        }
      }}
      {...props}>
  ...
  // Allow container override, or portal to body by default
